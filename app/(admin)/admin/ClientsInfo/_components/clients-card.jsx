...
const ClientCard = ({ account }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        ...
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className={`${fontZenKaku.className} text-base font-medium capitalize`}>{city}, {province}</CardTitle>
          </CardHeader>
      ...
      <DialogContent className={`${fontZenKaku.className} [&>button]:hidden w-[95vw] max-w-full sm:max-w-2xl p-0 sm:p-6 overflow-hidden max-h-[90vh] rounded-lg`}>
        <DialogHeader>
          <DialogTitle className="capitalize !font-bold text-2xl">{name}</DialogTitle>
          <DialogDescription className="font-normal tracking-wide text-sm">
        ...
        <div className="hidden md:grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
          {/* Basic Info */}
          <section>
            <h4 className="font-bold text-base md:text-lg text-gray-700 mb-2">Basic Info</h4>
          ...
          {/* Address */}
          <section>
            <h4 className="font-bold text-base md:text-lg text-gray-700 mb-2">Address</h4>
            <div className="space-y-1 text-sm">
          ...
          {/* Tax Info */}
          <section>
            <h4 className="font-bold text-base md:text-lg text-gray-700 mb-2">Tax Info</h4>
            <div className="space-y-1 text-sm">
              <div>
          ...
          {/* Affiliating Info */}
          <section>
            <h4 className="font-bold text-base md:text-lg text-gray-700 mb-2">Affiliating Information</h4>
            <div className="space-y-1 text-sm">
              <div>
